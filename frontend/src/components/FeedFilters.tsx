    ...
    <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 mb-6 flex flex-col md:flex-row gap-4">
      <div className="flex-grow relative">
        ...
        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          <svg role="presentation" className="h-5 w-5 text-gray-400" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {localQ && (
          ...
          >
            <svg role="presentation" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
