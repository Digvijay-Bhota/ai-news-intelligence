    ...
    <header className="bg-white shadow-sm sticky top-0 z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav className="hidden sm:flex space-x-6">
          ...
          <Link href="/foryou" className={`font-medium px-1 py-5 border-b-2 transition-colors ${pathname === '/foryou' ? 'text-indigo-600 border-indigo-600' : 'text-gray-500 hover:text-gray-900 border-transparent'}`}>For You</Link>
          ...
          <Link href="/settings" className={`font-medium px-1 py-5 border-b-2 transition-colors ${pathname === '/settings' ? 'text-indigo-600 border-indigo-600' : 'text-gray-500 hover:text-gray-900 border-transparent'}`}>Settings</Link>
        </nav>
